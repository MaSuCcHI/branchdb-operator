...
type mockVolumeProvider struct {
	takeSnapshotFunc  func(ctx context.Context, name string) error
...
func (m *mockVolumeProvider) TakeSnapshot(ctx context.Context, name string) error {
	return m.takeSnapshotFunc(ctx, name)
}
...
func TestHandler_正常なスナップショット削除は204を返す(t *testing.T) {
	...
	provider := &mockVolumeProvider{
		takeSnapshotFunc: func(ctx context.Context, name string) error { return nil },
		deleteCloneFunc: func(ctx context.Context, cloneName string) error {
